...
docker tag wildme/manylinux:opencv-4.2.0 docker.pkg.github.com/wildbookorg/wbia-pypkg-build/manylinux:opencv-4.2.0
docker tag wildme/manylinux:opencv-3.4.10 docker.pkg.github.com/wildbookorg/wbia-pypkg-build/manylinux:opencv-3.4.10
